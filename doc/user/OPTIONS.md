...
### `--roughness=<roughness>` (default: `0.3`)
...
### `--resolution=<width,height>` (default: `1000, 600`)
...
### `--camera-azimuth-angle=<angle>` (default: `0.0`)
...
### `--ref-threshold=<threshold>` (default: `50`)
